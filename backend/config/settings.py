...
def get_settings() -> Settings:
    ...
    return Settings(
        ...
        cors_origins=_parse_origins(os.getenv("CORS_ORIGINS", "http://localhost:5173,http://localhost:3000,http://localhost:3001,http://127.0.0.1:3001")),
        ...
        ai_verify_ssl=os.getenv("AI_VERIFY_SSL", "false").lower() == "true",
        ...
        embedding_api_path=os.getenv("EMBEDDING_API_PATH", ""),
